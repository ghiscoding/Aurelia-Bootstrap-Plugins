...
module.exports = {
  scripts: {
    ...
    webpack: {
      ...
      server: {
        default: `webpack-dev-server -d --devtool '#source-map' --inline --port ${SERVE_PORT} --env.server`,
        extractCss: `webpack-dev-server -d --devtool '#source-map' --inline --port ${SERVE_PORT} --env.server --env.extractCss`,
        hmr: `webpack-dev-server -d --devtool '#source-map' --inline --hot --port ${SERVE_PORT} --env.server`
      },
    },
