    ...
    execute: function () {
      _export('AbpSelectCustomElement', AbpSelectCustomElement = (_dec = inject(Element, UtilService), _dec2 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec3 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec4 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec(_class = (_class2 = function () {
        ...
        AbpSelectCustomElement.prototype.attached = function attached() {
          ...
          var pickerOptions = Object.assign({}, globalPickerOptions, this.pickerOptions || {});
        ...
        AbpSelectCustomElement.prototype.getMergedMappingStructure = function getMergedMappingStructure() {
          var dataMappingStructure = Object.assign({}, globalExtraOptions.mappingDataStructure, this.dataMappingStructure || {});
      ...
      _export('OptionalBindingBehavior', OptionalBindingBehavior = function () {
      ...
      _export('OptionalBindingBehavior', OptionalBindingBehavior);
    }
  };
});