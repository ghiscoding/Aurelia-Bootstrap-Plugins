...
System.register(['aurelia-framework', 'moment', 'jquery', 'eonasdan-bootstrap-datetimepicker'], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      _export('AbaDatetimePickerCustomElement', AbaDatetimePickerCustomElement = (_dec = inject(Element), _dec2 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec3 = bindable({ defaultBindingMode: bindingMode.twoWay }), _dec(_class = (_class2 = function () {
